...
/** Per-topic personal notes for the JS course — autosaves (debounced). */
export function JsNotes({ slug }) {
  const note = useJsProgress((s) => s.notes[slug] ?? '')
  const setNote = useJsProgress((s) => s.setNote)

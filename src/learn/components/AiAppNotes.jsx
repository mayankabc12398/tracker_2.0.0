...
/** Per-topic personal notes for the AI App Engineering course — autosaves (debounced). */
export function AiAppNotes({ slug }) {
  const note = useAiAppProgress((s) => s.notes[slug] ?? '')
  const setNote = useAiAppProgress((s) => s.setNote)
